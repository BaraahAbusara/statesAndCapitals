...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        List<StateInfo> firstFiveStates = states.subList(0,5);
        ...
        StateInfo cardinalState = states.stream().filter(state -> state.getStateBird()
                                                                        .equals("cardinal"))
        ...
        LocalDate earliestDateStateEnteredUnion = states.stream().min(Comparator.comparing(StateInfo::getDateAdmittedToUnion)).get().getDateAdmittedToUnion();
